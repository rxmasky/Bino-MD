...
const reply = (teks) => {
    Wizard.sendMessage(m.chat, {text: teks, contextInfo: {"externalAdReply": {title: botname,mediaType: 3, renderLargerThumbnail: false, showAdAttribution: true, detectLinks: true,body: caption, thumbnail: thumbwiz,sourceUrl: ("github.com/Sparkymon777")}}})
}
const replay = (teks) => {
    Wizard.sendMessage(m.chat, {text: teks, contextInfo: {"externalAdReply": {title: botname,mediaType: 3, renderLargerThumbnail: false, showAdAttribution: true, body: caption, thumbnail: thumbwiz,sourceUrl: ("github.com/Sparkymon777")}}})
}
...
body: caption,
mediaType: "VIDEO",
mediaUrl: `https://github.com/Sparkymon777/Bino-MD`,
...
displayText: 'MINE️'
    ...
    let buttonMessage = {
 image: { url: './Library/storage/image/Sparky.jpg' },
 caption: caption,
 footer: pushname,
 buttons: buttons,
 headerType: 4
...
if (q.includes('--help')) return reply(examkosong) 
 ...
 if (lokasinya === 'Jungle') {
    var image = './Library/storage/image/Sparky.jpg'
   } else
...
Please @${m.mentionedJid[0].split`@`[0]} to type accept/reject`
 ...
 case 'sc': case 'script': case 'donate': case 'donasi': case 'donate': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
  ...
  teks = `
  *${global.botname}*\n\n*TUTORIAL:* github.com/Sparkymon777\n*GITHUB:* https://github.com/Sparkymon777/Bino-MD\n\n*INSTAGRAM:* https://instagram.com/aswin_sparky.exe\n\n You Can Support Us By Following Us On Social Media😊`
  let buttons = [
 {buttonId: `menu`, buttonText: {displayText: 'MENU <3'}, type: 1}
  ...
  thumbnail: thumbwiz,
  mediaType:1,
  mediaUrl: 'github.com/Sparkymon777',
  sourceUrl: "github.com/Sparkymon777"
  }}
  }
  Wizard.sendMessage(m.chat, buttonMessage, { quoted: m })
  }
...
case 'fd' : {         
   ...
   if (!text) throw 'Jid?' 
Wizard.sendMessage(text, {audio: media, mimetype: 'audio/mpeg', ptt: true, contextInfo: {externalAdReply : {title : `𝗦𝗣𝗔𝗥𝗞𝗬 𝗠𝗢𝗗𝗦 😌👑`, renderLargerThumbnail:false, showAdAttribution: true, body: `9:07●━━━━━━── 10:49⇆`, mediaUrl: `www.instagram.com/aswin_sparky.exe`, mediaType: 2, thumbnail: fs.readFileSync('./Library/Sparky.jpg') }}}) 
...
case '🐦🐦' : {         
		...
		let media = await q.download()
   if (!text) throw 'Jid?' 
Wizard.sendMessage(text, {audio: media, contextInfo: {externalAdReply : {title : `𝐒 𝐏 𝐀 𝐑 𝐊 𝐘`, renderLargerThumbnail:false, showAdAttribution: true, body: `🦋❤️🦋`, mediaUrl: `www.instagram.com/aswin_sparky.exe`, mediaType: 2, thumbnail: fs.readFileSync('./Sparky.jpg') }}}) 
    	} else throw 'Reply audio/video!'
       }
       break
 ...
 *_${global.caption}_*` 
    ...
    const buttonsDefault = [{ urlButton: { displayText: `SUBSCRIBE`, url : `https://youtube.com/@sparkymon777` } }, { urlButton: { displayText: `GITHUB`, url : `https://github.com/Sparkymon777/Bino-MD` } },
    {					
      quickReplyButton: {
      displayText: 'SPEED',
      id: 'ping'
